...
var defaultInnerRenderer = function defaultInnerRenderer(props) {
  return react.createElement('div', props);
};

var defaultOuterRenderer = function defaultOuterRenderer(innerComponent, props) {
  return react.createElement('div', props, innerComponent);
};
...
function createGridComponent(_ref2) {
  ...
  function (_PureComponent) {
    ...
    _proto.forceUpdateGrid = function forceUpdateGrid() {
    ...
    _proto.render = function render() {
      var _this$props4 = this.props,
          ...
          outerRenderer = _this$props4$outerRen === void 0 ? defaultOuterRenderer : _this$props4$outerRen;
      ...
      var _this$_getVerticalRan = this._getVerticalRangeToRender(),
          ...
          rowStopIndex = _this$_getVerticalRan[1]; // const items = [];
      ...
      var innerComponent = innerRenderer({
        // children: items,
        ref: innerRef,
    ...
    _proto._callPropsCallbacks = function _callPropsCallbacks() {
      ...
      if (typeof onScroll === 'function') {
        var _this$state4 = this.state,
            _horizontalScrollDirection = _this$state4.horizontalScrollDirection,
            _scrollLeft = _this$state4.scrollLeft,
            _scrollTop = _this$state4.scrollTop,
            _scrollUpdateWasRequested = _this$state4.scrollUpdateWasRequested,
            _verticalScrollDirection = _this$state4.verticalScrollDirection;
    ...
    _proto._getHorizontalRangeToRender = function _getHorizontalRangeToRender() {
      ...
      var _this$state5 = this.state,
          horizontalScrollDirection = _this$state5.horizontalScrollDirection,
    ...
    _proto._getVerticalRangeToRender = function _getVerticalRangeToRender() {
      ...
      var _this$state6 = this.state,
          ...
          verticalScrollDirection = _this$state6.verticalScrollDirection,
